FHR - Alt Assembly Pin Cell - UC - None - 0.319 cm radius - 0.184 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.64302734375  0.0  0.0   $ vector to first facet 
              0.321513671875  -0.556878015016  0.0   $ vector to second facet 
              -0.321513671875  -0.556878015016  0.0   $ vector to third facet 
