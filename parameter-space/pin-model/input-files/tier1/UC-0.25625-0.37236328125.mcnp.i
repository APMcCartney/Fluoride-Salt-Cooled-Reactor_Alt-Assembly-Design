FHR - Alt Assembly Pin Cell - UC - None - 0.256 cm radius - 0.372 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.76861328125  0.0  0.0   $ vector to first facet 
              0.384306640625  -0.665638627249  0.0   $ vector to second facet 
              -0.384306640625  -0.665638627249  0.0   $ vector to third facet 
