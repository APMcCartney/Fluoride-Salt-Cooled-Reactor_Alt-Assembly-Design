FHR - Alt Assembly Pin Cell - UC - None - 0.350 cm radius - 0.394 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
c ~~~ surface cards ~~~~~~~
c 
 0001     cz 0.35 $ fuel-radius
 0011     cz 0.39 $ fuel-radius + gap-width
 0012     cz 0.49 $ fuel-radius + gap-width + clad-thickness
*1001     hex 0.0  0.0  -2.5 $ hex-base
              0.0  0.0  5.0 $ hex-height
              0.88375  0.0  0.0   $ vector to first facet 
              0.441875  -0.765349950594  0.0   $ vector to second facet 
              -0.441875  -0.765349950594  0.0   $ vector to third facet 
