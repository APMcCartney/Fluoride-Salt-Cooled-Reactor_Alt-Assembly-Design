FHR - Alt Assembly Pin Cell - UC - None - 0.194 cm radius - 0.070 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
c ~~~ surface cards ~~~~~~~
c 
 0001     cz 0.19375 $ fuel-radius
 0011     cz 0.23375 $ fuel-radius + gap-width
 0012     cz 0.33375 $ fuel-radius + gap-width + clad-thickness
*1001     hex 0.0  0.0  -2.5 $ hex-base
              0.0  0.0  5.0 $ hex-height
              0.40337890625  0.0  0.0   $ vector to first facet 
              0.201689453125  -0.349336380163  0.0   $ vector to second facet 
              -0.201689453125  -0.349336380163  0.0   $ vector to third facet 
