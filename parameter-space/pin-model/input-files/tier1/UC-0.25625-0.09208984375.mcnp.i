FHR - Alt Assembly Pin Cell - UC - None - 0.256 cm radius - 0.092 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
c ~~~ surface cards ~~~~~~~
c 
 0001     cz 0.25625 $ fuel-radius
 0011     cz 0.29625 $ fuel-radius + gap-width
 0012     cz 0.39625 $ fuel-radius + gap-width + clad-thickness
*1001     hex 0.0  0.0  -2.5 $ hex-base
              0.0  0.0  5.0 $ hex-height
              0.48833984375  0.0  0.0   $ vector to first facet 
              0.244169921875  -0.422914710368  0.0   $ vector to second facet 
              -0.244169921875  -0.422914710368  0.0   $ vector to third facet 
