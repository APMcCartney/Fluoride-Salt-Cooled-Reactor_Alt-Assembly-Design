FHR - Alt Assembly Pin Cell - UC - None - 0.100 cm radius - 0.200 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.44  0.0  0.0   $ vector to first facet 
              0.22  -0.381051177665  0.0   $ vector to second facet 
              -0.22  -0.381051177665  0.0   $ vector to third facet 
