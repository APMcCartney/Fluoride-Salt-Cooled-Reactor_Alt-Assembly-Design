FHR - Alt Assembly Pin Cell - UC - None - 0.162 cm radius - 0.289 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.591953125  0.0  0.0   $ vector to first facet 
              0.2959765625  -0.5126464441  0.0   $ vector to second facet 
              -0.2959765625  -0.5126464441  0.0   $ vector to third facet 
