FHR - Alt Assembly Pin Cell - UC - None - 0.256 cm radius - 0.316 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.71255859375  0.0  0.0   $ vector to first facet 
              0.356279296875  -0.617093843872  0.0   $ vector to second facet 
              -0.356279296875  -0.617093843872  0.0   $ vector to third facet 
