FHR - Alt Assembly Pin Cell - UC - None - 0.319 cm radius - 0.533 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.99166015625  0.0  0.0   $ vector to first facet 
              0.495830078125  -0.858802887233  0.0   $ vector to second facet 
              -0.495830078125  -0.858802887233  0.0   $ vector to third facet 
