FHR - Alt Assembly Pin Cell - UC - None - 0.537 cm radius - 0.722 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              1.399765625  0.0  0.0   $ vector to first facet 
              0.6998828125  -1.21223259059  0.0   $ vector to second facet 
              -0.6998828125  -1.21223259059  0.0   $ vector to third facet 
