FHR - Alt Assembly Pin Cell - UC - None - 0.131 cm radius - 0.076 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.34712890625  0.0  0.0   $ vector to first facet 
              0.173564453125  -0.3006224512  0.0   $ vector to second facet 
              -0.173564453125  -0.3006224512  0.0   $ vector to third facet 
