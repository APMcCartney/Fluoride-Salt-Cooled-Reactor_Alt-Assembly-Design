FHR - Alt Assembly Pin Cell - UC - None - 0.319 cm radius - 0.254 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.71275390625  0.0  0.0   $ vector to first facet 
              0.356376953125  -0.617262989459  0.0   $ vector to second facet 
              -0.356376953125  -0.617262989459  0.0   $ vector to third facet 
