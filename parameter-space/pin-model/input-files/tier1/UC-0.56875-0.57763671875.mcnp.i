FHR - Alt Assembly Pin Cell - UC - None - 0.569 cm radius - 0.578 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              1.28638671875  0.0  0.0   $ vector to first facet 
              0.643193359375  -1.11404357753  0.0   $ vector to second facet 
              -0.643193359375  -1.11404357753  0.0   $ vector to third facet 
