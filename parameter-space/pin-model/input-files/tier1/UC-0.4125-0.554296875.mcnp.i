FHR - Alt Assembly Pin Cell - UC - None - 0.412 cm radius - 0.554 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              1.106796875  0.0  0.0   $ vector to first facet 
              0.5533984375  -0.958514210579  0.0   $ vector to second facet 
              -0.5533984375  -0.958514210579  0.0   $ vector to third facet 
