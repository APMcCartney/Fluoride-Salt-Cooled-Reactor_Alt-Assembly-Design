FHR - Alt Assembly Pin Cell - UC - None - 0.225 cm radius - 0.155 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
c ~~~ surface cards ~~~~~~~
c 
 0001     cz 0.225 $ fuel-radius
 0011     cz 0.265 $ fuel-radius + gap-width
 0012     cz 0.365 $ fuel-radius + gap-width + clad-thickness
*1001     hex 0.0  0.0  -2.5 $ hex-base
              0.0  0.0  5.0 $ hex-height
              0.5196875  0.0  0.0   $ vector to first facet 
              0.25984375  -0.450062577029  0.0   $ vector to second facet 
              -0.25984375  -0.450062577029  0.0   $ vector to third facet 
