FHR - Alt Assembly Pin Cell - UC - None - 0.569 cm radius - 0.702 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              1.41080078125  0.0  0.0   $ vector to first facet 
              0.705400390625  -1.22178931624  0.0   $ vector to second facet 
              -0.705400390625  -1.22178931624  0.0   $ vector to third facet 
