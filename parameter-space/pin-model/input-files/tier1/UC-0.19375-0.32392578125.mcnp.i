FHR - Alt Assembly Pin Cell - UC - None - 0.194 cm radius - 0.324 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.65767578125  0.0  0.0   $ vector to first facet 
              0.328837890625  -0.569563934016  0.0   $ vector to second facet 
              -0.328837890625  -0.569563934016  0.0   $ vector to third facet 
