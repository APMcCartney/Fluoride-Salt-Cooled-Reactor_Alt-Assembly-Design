FHR - Alt Assembly Pin Cell - UC - None - 0.506 cm radius - 0.625 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              1.27115234375  0.0  0.0   $ vector to first facet 
              0.635576171875  -1.10085022177  0.0   $ vector to second facet 
              -0.635576171875  -1.10085022177  0.0   $ vector to third facet 
