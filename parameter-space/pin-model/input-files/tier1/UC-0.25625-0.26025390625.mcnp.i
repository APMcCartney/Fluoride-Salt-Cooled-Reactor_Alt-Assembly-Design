FHR - Alt Assembly Pin Cell - UC - None - 0.256 cm radius - 0.260 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.65650390625  0.0  0.0   $ vector to first facet 
              0.328251953125  -0.568549060496  0.0   $ vector to second facet 
              -0.328251953125  -0.568549060496  0.0   $ vector to third facet 
