FHR - Alt Assembly Pin Cell - UC - None - 0.287 cm radius - 0.386 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.813828125  0.0  0.0   $ vector to first facet 
              0.4069140625  -0.704795830564  0.0   $ vector to second facet 
              -0.4069140625  -0.704795830564  0.0   $ vector to third facet 
