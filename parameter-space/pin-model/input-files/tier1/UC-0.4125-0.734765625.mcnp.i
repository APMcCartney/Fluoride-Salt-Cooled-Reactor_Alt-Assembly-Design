FHR - Alt Assembly Pin Cell - UC - None - 0.412 cm radius - 0.735 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              1.287265625  0.0  0.0   $ vector to first facet 
              0.6436328125  -1.11480473267  0.0   $ vector to second facet 
              -0.6436328125  -1.11480473267  0.0   $ vector to third facet 
