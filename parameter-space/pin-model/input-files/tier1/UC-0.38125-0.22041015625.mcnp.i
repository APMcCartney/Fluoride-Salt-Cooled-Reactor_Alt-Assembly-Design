FHR - Alt Assembly Pin Cell - UC - None - 0.381 cm radius - 0.220 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.74166015625  0.0  0.0   $ vector to first facet 
              0.370830078125  -0.642296536287  0.0   $ vector to second facet 
              -0.370830078125  -0.642296536287  0.0   $ vector to third facet 
