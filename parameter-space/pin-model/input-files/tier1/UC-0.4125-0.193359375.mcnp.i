FHR - Alt Assembly Pin Cell - UC - None - 0.412 cm radius - 0.193 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
c ~~~ surface cards ~~~~~~~
c 
 0001     cz 0.4125 $ fuel-radius
 0011     cz 0.4525 $ fuel-radius + gap-width
 0012     cz 0.5525 $ fuel-radius + gap-width + clad-thickness
*1001     hex 0.0  0.0  -2.5 $ hex-base
              0.0  0.0  5.0 $ hex-height
              0.745859375  0.0  0.0   $ vector to first facet 
              0.3729296875  -0.645933166401  0.0   $ vector to second facet 
              -0.3729296875  -0.645933166401  0.0   $ vector to third facet 
