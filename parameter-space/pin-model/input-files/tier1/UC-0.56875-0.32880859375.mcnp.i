FHR - Alt Assembly Pin Cell - UC - None - 0.569 cm radius - 0.329 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
c ~~~ surface cards ~~~~~~~
c 
 0001     cz 0.56875 $ fuel-radius
 0011     cz 0.60875 $ fuel-radius + gap-width
 0012     cz 0.70875 $ fuel-radius + gap-width + clad-thickness
*1001     hex 0.0  0.0  -2.5 $ hex-base
              0.0  0.0  5.0 $ hex-height
              1.03755859375  0.0  0.0   $ vector to first facet 
              0.518779296875  -0.898552100102  0.0   $ vector to second facet 
              -0.518779296875  -0.898552100102  0.0   $ vector to third facet 
