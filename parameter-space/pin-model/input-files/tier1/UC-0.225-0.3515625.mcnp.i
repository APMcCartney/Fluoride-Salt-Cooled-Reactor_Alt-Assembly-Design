FHR - Alt Assembly Pin Cell - UC - None - 0.225 cm radius - 0.352 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.7165625  0.0  0.0   $ vector to first facet 
              0.35828125  -0.620561328399  0.0   $ vector to second facet 
              -0.35828125  -0.620561328399  0.0   $ vector to third facet 
