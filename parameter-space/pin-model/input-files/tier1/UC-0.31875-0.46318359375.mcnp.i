FHR - Alt Assembly Pin Cell - UC - None - 0.319 cm radius - 0.463 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.92193359375  0.0  0.0   $ vector to first facet 
              0.460966796875  -0.79841791279  0.0   $ vector to second facet 
              -0.460966796875  -0.79841791279  0.0   $ vector to third facet 
