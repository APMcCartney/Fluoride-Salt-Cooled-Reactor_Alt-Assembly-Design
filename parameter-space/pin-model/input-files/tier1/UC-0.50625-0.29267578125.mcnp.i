FHR - Alt Assembly Pin Cell - UC - None - 0.506 cm radius - 0.293 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.93892578125  0.0  0.0   $ vector to first facet 
              0.469462890625  -0.813133578831  0.0   $ vector to second facet 
              -0.469462890625  -0.813133578831  0.0   $ vector to third facet 
