FHR - Alt Assembly Pin Cell - UC - None - 0.381 cm radius - 0.637 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              1.15865234375  0.0  0.0   $ vector to first facet 
              0.579326171875  -1.00342236384  0.0   $ vector to second facet 
              -0.579326171875  -1.00342236384  0.0   $ vector to third facet 
