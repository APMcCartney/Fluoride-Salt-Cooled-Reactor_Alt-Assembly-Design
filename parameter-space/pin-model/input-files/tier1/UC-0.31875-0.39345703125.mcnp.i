FHR - Alt Assembly Pin Cell - UC - None - 0.319 cm radius - 0.393 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.85220703125  0.0  0.0   $ vector to first facet 
              0.426103515625  -0.738032938346  0.0   $ vector to second facet 
              -0.426103515625  -0.738032938346  0.0   $ vector to third facet 
