FHR - Alt Assembly Pin Cell - UC - None - 0.444 cm radius - 0.451 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
c ~~~ surface cards ~~~~~~~
c 
 0001     cz 0.44375 $ fuel-radius
 0011     cz 0.48375 $ fuel-radius + gap-width
 0012     cz 0.58375 $ fuel-radius + gap-width + clad-thickness
*1001     hex 0.0  0.0  -2.5 $ hex-base
              0.0  0.0  5.0 $ hex-height
              1.03443359375  0.0  0.0   $ vector to first facet 
              0.517216796875  -0.895845770716  0.0   $ vector to second facet 
              -0.517216796875  -0.895845770716  0.0   $ vector to third facet 
