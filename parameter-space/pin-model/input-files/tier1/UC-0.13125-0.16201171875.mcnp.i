FHR - Alt Assembly Pin Cell - UC - None - 0.131 cm radius - 0.162 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.43326171875  0.0  0.0   $ vector to first facet 
              0.216630859375  -0.375215654925  0.0   $ vector to second facet 
              -0.216630859375  -0.375215654925  0.0   $ vector to third facet 
