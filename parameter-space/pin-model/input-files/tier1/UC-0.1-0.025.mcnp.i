FHR - Alt Assembly Pin Cell - UC - None - 0.100 cm radius - 0.025 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
c ~~~ surface cards ~~~~~~~
c 
 0001     cz 0.1 $ fuel-radius
 0011     cz 0.14 $ fuel-radius + gap-width
 0012     cz 0.24 $ fuel-radius + gap-width + clad-thickness
*1001     hex 0.0  0.0  -2.5 $ hex-base
              0.0  0.0  5.0 $ hex-height
              0.265  0.0  0.0   $ vector to first facet 
              0.1325  -0.229496732003  0.0   $ vector to second facet 
              -0.1325  -0.229496732003  0.0   $ vector to third facet 
