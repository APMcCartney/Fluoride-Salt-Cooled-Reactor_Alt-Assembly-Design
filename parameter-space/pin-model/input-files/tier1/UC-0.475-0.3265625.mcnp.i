FHR - Alt Assembly Pin Cell - UC - None - 0.475 cm radius - 0.327 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
c ~~~ surface cards ~~~~~~~
c 
 0001     cz 0.475 $ fuel-radius
 0011     cz 0.515 $ fuel-radius + gap-width
 0012     cz 0.615 $ fuel-radius + gap-width + clad-thickness
*1001     hex 0.0  0.0  -2.5 $ hex-base
              0.0  0.0  5.0 $ hex-height
              0.9415625  0.0  0.0   $ vector to first facet 
              0.47078125  -0.815417044251  0.0   $ vector to second facet 
              -0.47078125  -0.815417044251  0.0   $ vector to third facet 
