FHR - Alt Assembly Pin Cell - UC - None - 0.569 cm radius - 0.826 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              1.53521484375  0.0  0.0   $ vector to first facet 
              0.767607421875  -1.32953505495  0.0   $ vector to second facet 
              -0.767607421875  -1.32953505495  0.0   $ vector to third facet 
