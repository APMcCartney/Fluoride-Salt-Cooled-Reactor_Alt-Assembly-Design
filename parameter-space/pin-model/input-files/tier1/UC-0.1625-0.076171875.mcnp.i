FHR - Alt Assembly Pin Cell - UC - None - 0.162 cm radius - 0.076 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
c ~~~ surface cards ~~~~~~~
c 
 0001     cz 0.1625 $ fuel-radius
 0011     cz 0.2025 $ fuel-radius + gap-width
 0012     cz 0.3025 $ fuel-radius + gap-width + clad-thickness
*1001     hex 0.0  0.0  -2.5 $ hex-base
              0.0  0.0  5.0 $ hex-height
              0.378671875  0.0  0.0   $ vector to first facet 
              0.1893359375  -0.327939463449  0.0   $ vector to second facet 
              -0.1893359375  -0.327939463449  0.0   $ vector to third facet 
