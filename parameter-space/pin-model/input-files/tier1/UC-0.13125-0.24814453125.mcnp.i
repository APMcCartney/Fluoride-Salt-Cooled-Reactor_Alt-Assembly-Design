FHR - Alt Assembly Pin Cell - UC - None - 0.131 cm radius - 0.248 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.51939453125  0.0  0.0   $ vector to first facet 
              0.259697265625  -0.449808858649  0.0   $ vector to second facet 
              -0.259697265625  -0.449808858649  0.0   $ vector to third facet 
