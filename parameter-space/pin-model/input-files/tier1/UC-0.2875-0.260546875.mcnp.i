FHR - Alt Assembly Pin Cell - UC - None - 0.287 cm radius - 0.261 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.688046875  0.0  0.0   $ vector to first facet 
              0.3440234375  -0.595866072744  0.0   $ vector to second facet 
              -0.3440234375  -0.595866072744  0.0   $ vector to third facet 
