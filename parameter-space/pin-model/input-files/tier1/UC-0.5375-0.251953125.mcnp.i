FHR - Alt Assembly Pin Cell - UC - None - 0.537 cm radius - 0.252 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
c ~~~ surface cards ~~~~~~~
c 
 0001     cz 0.5375 $ fuel-radius
 0011     cz 0.5775 $ fuel-radius + gap-width
 0012     cz 0.6775 $ fuel-radius + gap-width + clad-thickness
*1001     hex 0.0  0.0  -2.5 $ hex-base
              0.0  0.0  5.0 $ hex-height
              0.929453125  0.0  0.0   $ vector to first facet 
              0.4647265625  -0.804930017877  0.0   $ vector to second facet 
              -0.4647265625  -0.804930017877  0.0   $ vector to third facet 
