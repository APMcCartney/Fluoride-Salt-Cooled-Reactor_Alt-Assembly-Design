FHR - Alt Assembly Pin Cell - UC - None - 0.131 cm radius - 0.047 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.31841796875  0.0  0.0   $ vector to first facet 
              0.159208984375  -0.275758049959  0.0   $ vector to second facet 
              -0.159208984375  -0.275758049959  0.0   $ vector to third facet 
