FHR - Alt Assembly Pin Cell - UC - None - 0.506 cm radius - 0.514 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              1.16041015625  0.0  0.0   $ vector to first facet 
              0.580205078125  -1.00494467412  0.0   $ vector to second facet 
              -0.580205078125  -1.00494467412  0.0   $ vector to third facet 
