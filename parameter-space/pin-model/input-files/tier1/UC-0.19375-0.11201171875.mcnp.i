FHR - Alt Assembly Pin Cell - UC - None - 0.194 cm radius - 0.112 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.44576171875  0.0  0.0   $ vector to first facet 
              0.222880859375  -0.386040972472  0.0   $ vector to second facet 
              -0.222880859375  -0.386040972472  0.0   $ vector to third facet 
