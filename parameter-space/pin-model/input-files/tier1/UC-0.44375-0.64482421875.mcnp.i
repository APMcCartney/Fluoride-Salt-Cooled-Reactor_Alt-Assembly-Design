FHR - Alt Assembly Pin Cell - UC - None - 0.444 cm radius - 0.645 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              1.22857421875  0.0  0.0   $ vector to first facet 
              0.614287109375  -1.06397648387  0.0   $ vector to second facet 
              -0.614287109375  -1.06397648387  0.0   $ vector to third facet 
