FHR - Alt Assembly Pin Cell - UC - None - 0.162 cm radius - 0.147 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.449765625  0.0  0.0   $ vector to first facet 
              0.2248828125  -0.389508456999  0.0   $ vector to second facet 
              -0.2248828125  -0.389508456999  0.0   $ vector to third facet 
