FHR - Alt Assembly Pin Cell - UC - None - 0.506 cm radius - 0.182 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
c ~~~ surface cards ~~~~~~~
c 
 0001     cz 0.50625 $ fuel-radius
 0011     cz 0.54625 $ fuel-radius + gap-width
 0012     cz 0.64625 $ fuel-radius + gap-width + clad-thickness
*1001     hex 0.0  0.0  -2.5 $ hex-base
              0.0  0.0  5.0 $ hex-height
              0.82818359375  0.0  0.0   $ vector to first facet 
              0.414091796875  -0.717228031185  0.0   $ vector to second facet 
              -0.414091796875  -0.717228031185  0.0   $ vector to third facet 
