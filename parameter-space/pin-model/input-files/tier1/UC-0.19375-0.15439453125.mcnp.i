FHR - Alt Assembly Pin Cell - UC - None - 0.194 cm radius - 0.154 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.48814453125  0.0  0.0   $ vector to first facet 
              0.244072265625  -0.422745564781  0.0   $ vector to second facet 
              -0.244072265625  -0.422745564781  0.0   $ vector to third facet 
