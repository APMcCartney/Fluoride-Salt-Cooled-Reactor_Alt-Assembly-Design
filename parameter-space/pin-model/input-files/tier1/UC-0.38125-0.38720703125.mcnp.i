FHR - Alt Assembly Pin Cell - UC - None - 0.381 cm radius - 0.387 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
c ~~~ surface cards ~~~~~~~
c 
 0001     cz 0.38125 $ fuel-radius
 0011     cz 0.42125 $ fuel-radius + gap-width
 0012     cz 0.52125 $ fuel-radius + gap-width + clad-thickness
*1001     hex 0.0  0.0  -2.5 $ hex-base
              0.0  0.0  5.0 $ hex-height
              0.90845703125  0.0  0.0   $ vector to first facet 
              0.454228515625  -0.786746867309  0.0   $ vector to second facet 
              -0.454228515625  -0.786746867309  0.0   $ vector to third facet 
