FHR - Alt Assembly Pin Cell - UC - None - 0.287 cm radius - 0.512 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.939609375  0.0  0.0   $ vector to first facet 
              0.4698046875  -0.813725588384  0.0   $ vector to second facet 
              -0.4698046875  -0.813725588384  0.0   $ vector to third facet 
