FHR - Alt Assembly Pin Cell - UC - None - 0.162 cm radius - 0.218 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.520859375  0.0  0.0   $ vector to first facet 
              0.2604296875  -0.451077450549  0.0   $ vector to second facet 
              -0.2604296875  -0.451077450549  0.0   $ vector to third facet 
