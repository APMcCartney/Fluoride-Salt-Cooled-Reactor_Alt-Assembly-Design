FHR - Alt Assembly Pin Cell - UC - None - 0.194 cm radius - 0.282 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.61529296875  0.0  0.0   $ vector to first facet 
              0.307646484375  -0.532859341707  0.0   $ vector to second facet 
              -0.307646484375  -0.532859341707  0.0   $ vector to third facet 
