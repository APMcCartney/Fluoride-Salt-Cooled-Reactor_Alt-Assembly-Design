FHR - Alt Assembly Pin Cell - UC - None - 0.194 cm radius - 0.239 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.57291015625  0.0  0.0   $ vector to first facet 
              0.286455078125  -0.496154749399  0.0   $ vector to second facet 
              -0.286455078125  -0.496154749399  0.0   $ vector to third facet 
