FHR - Alt Assembly Pin Cell - UC - None - 0.287 cm radius - 0.135 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
c ~~~ surface cards ~~~~~~~
c 
 0001     cz 0.2875 $ fuel-radius
 0011     cz 0.3275 $ fuel-radius + gap-width
 0012     cz 0.4275 $ fuel-radius + gap-width + clad-thickness
*1001     hex 0.0  0.0  -2.5 $ hex-base
              0.0  0.0  5.0 $ hex-height
              0.562265625  0.0  0.0   $ vector to first facet 
              0.2811328125  -0.486936314925  0.0   $ vector to second facet 
              -0.2811328125  -0.486936314925  0.0   $ vector to third facet 
