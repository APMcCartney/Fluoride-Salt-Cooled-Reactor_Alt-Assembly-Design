FHR - Alt Assembly Pin Cell - UC - None - 0.131 cm radius - 0.133 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.40455078125  0.0  0.0   $ vector to first facet 
              0.202275390625  -0.350351253683  0.0   $ vector to second facet 
              -0.202275390625  -0.350351253683  0.0   $ vector to third facet 
