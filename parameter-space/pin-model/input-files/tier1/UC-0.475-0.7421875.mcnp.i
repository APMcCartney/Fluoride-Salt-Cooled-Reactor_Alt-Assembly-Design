FHR - Alt Assembly Pin Cell - UC - None - 0.475 cm radius - 0.742 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              1.3571875  0.0  0.0   $ vector to first facet 
              0.67859375  -1.1753588527  0.0   $ vector to second facet 
              -0.67859375  -1.1753588527  0.0   $ vector to third facet 
