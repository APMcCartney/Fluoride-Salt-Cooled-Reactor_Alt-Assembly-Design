FHR - Alt Assembly Pin Cell - UC - None - 0.600 cm radius - 0.150 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.89  0.0  0.0   $ vector to first facet 
              0.445  -0.770762609368  0.0   $ vector to second facet 
              -0.445  -0.770762609368  0.0   $ vector to third facet 
