FHR - Alt Assembly Pin Cell - UC - None - 0.131 cm radius - 0.191 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
c ~~~ surface cards ~~~~~~~
c 
 0001     cz 0.13125 $ fuel-radius
 0011     cz 0.17125 $ fuel-radius + gap-width
 0012     cz 0.27125 $ fuel-radius + gap-width + clad-thickness
*1001     hex 0.0  0.0  -2.5 $ hex-base
              0.0  0.0  5.0 $ hex-height
              0.46197265625  0.0  0.0   $ vector to first facet 
              0.230986328125  -0.400080056166  0.0   $ vector to second facet 
              -0.230986328125  -0.400080056166  0.0   $ vector to third facet 
