FHR - Alt Assembly Pin Cell - UC - None - 0.381 cm radius - 0.721 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              1.24205078125  0.0  0.0   $ vector to first facet 
              0.621025390625  -1.07564752935  0.0   $ vector to second facet 
              -0.621025390625  -1.07564752935  0.0   $ vector to third facet 
