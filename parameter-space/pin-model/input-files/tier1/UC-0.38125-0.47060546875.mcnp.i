FHR - Alt Assembly Pin Cell - UC - None - 0.381 cm radius - 0.471 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              0.99185546875  0.0  0.0   $ vector to first facet 
              0.495927734375  -0.85897203282  0.0   $ vector to second facet 
              -0.495927734375  -0.85897203282  0.0   $ vector to third facet 
