FHR - Alt Assembly Pin Cell - UC - None - 0.537 cm radius - 0.487 cm margin
c 
c ~~~ cells cards ~~~~~~~
c 
...
*1001     hex 0.0  0.0  -2.5 $ hex-base
              ...
              1.164609375  0.0  0.0   $ vector to first facet 
              0.5823046875  -1.00858130424  0.0   $ vector to second facet 
              -0.5823046875  -1.00858130424  0.0   $ vector to third facet 
